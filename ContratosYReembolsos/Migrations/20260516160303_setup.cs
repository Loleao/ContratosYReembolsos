    ...
    public partial class setup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fallecidos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActiveInternal = table.Column<bool>(type: "bit", nullable: false),
                    IsActiveExternal = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolicitorCip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CustomWakeAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CemeteryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "DetallesServiciosContrato",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContractId = table.Column<int>(type: "int", nullable: false),
                    FuneralServiceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesServiciosContrato", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetallesServiciosContrato_Contratos_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contratos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallesServiciosContrato_ServiciosFunerarios_FuneralServiceId",
                        column: x => x.FuneralServiceId,
            ...
            migrationBuilder.CreateTable(
                name: "DetallesServiciosExternoContrato",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesServiciosExternoContrato", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetallesServiciosExternoContrato_Contratos_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contratos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallesServiciosExternoContrato_ServiciosFunerarios_FuneralServiceId",
                        column: x => x.FuneralServiceId,
                        principalTable: "ServiciosFunerarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalContractId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exhumaciones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Exhumaciones_Contratos_OriginalContractId",
                        column: x => x.OriginalContractId,
                        principalTable: "Contratos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Exhumaciones_Fallecidos_DeceasedId",
                        column: x => x.DeceasedId,
                        principalTable: "Fallecidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SepulturasHistorial",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IntermentSpaceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SepulturasHistorial", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SepulturasHistorial_Fallecidos_DeceasedId",
                        column: x => x.DeceasedId,
                        principalTable: "Fallecidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SepulturasHistorial_SepulturasNichos_IntermentSpaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesServiciosContrato_ContractId",
                table: "DetallesServiciosContrato",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesServiciosContrato_FuneralServiceId",
                table: "DetallesServiciosContrato",
                column: "FuneralServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesServiciosExternoContrato_ContractId",
                table: "DetallesServiciosExternoContrato",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesServiciosExternoContrato_FuneralServiceId",
                table: "DetallesServiciosExternoContrato",
                column: "FuneralServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Exhumaciones_DeceasedId",
                table: "Exhumaciones",
                column: "DeceasedId");

            migrationBuilder.CreateIndex(
                name: "IX_Exhumaciones_OriginalContractId",
                table: "Exhumaciones",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SepulturasHistorial_DeceasedId",
                table: "SepulturasHistorial",
                column: "DeceasedId");

            migrationBuilder.CreateIndex(
                name: "IX_SepulturasHistorial_IntermentSpaceId",
                table: "SepulturasHistorial",
                column: "IntermentSpaceId");
